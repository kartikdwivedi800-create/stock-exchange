...
- **Profile**: `GET` / `PUT http://localhost:8081/api/v1/users/me` (header `X-User-Id`)
...
> Errors use the shared `ErrorResponse` from common-library. Passwords and tokens are still mocks until Sprint 3 (NX-301/302).
